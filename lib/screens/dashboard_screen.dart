...
import 'package:huggets_app/screens/clients_screen.dart';
import 'package:huggets_app/screens/owner_profile_screen.dart';
import 'package:huggets_app/screens/expiring_members_screen.dart';
import 'package:huggets_app/screens/customer_detail_screen.dart';
...
class DashboardScreen extends ConsumerWidget {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              _buildTrainingStatsCard(selfTraining, personalTraining),
              SizedBox(height: 24),
              _buildSectionTitle(
  ...
  Widget _buildTrainingStatsCard(int selfTraining, int personalTraining) {
    final total = selfTraining + personalTraining;
